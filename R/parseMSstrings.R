...
#'parse_mods
#'Extracting metadata from an annotated peptide sequence from Spectronaut
#'
#'@param seqs A character vector of peptide sequences
#'@param format A character value specifiying the format of seqs (not currently implemented - function expects spectronaut format for now)
#'
#'@returns A `proteins_mods` object with processed sequences
#'@export
